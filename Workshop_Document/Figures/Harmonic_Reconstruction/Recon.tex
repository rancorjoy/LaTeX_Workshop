...
% Plot parameters
\pgfmathsetmacro\xbound{1.5}   % x-axis limits
\pgfmathsetmacro\n{4}     	  % number of harmonics in the reconstruction
\pgfmathsetmacro\wc{10/(2*pi)} % cutoff in harmonic units k_c = wc/w0 (multiple of fundamental frequency)
